...
- **R8b (this)** — CHANGELOG catch-up; `reality-thriving-transfer` Cargo.toml AG-SML **v1.1**; lived-tick doc Done. No `lib.rs` rewrite (#464 closed after PLACEHOLDER stub). Math digest / paid SKUs still held.
