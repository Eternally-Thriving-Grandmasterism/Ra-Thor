...
//!
//! Now includes ShardManager with full PATSAGi Council + EpigeneticModulation integration for interest routing and proposal decisions.
...
pub use shard_manager::{ShardManager, InterestSet};

// ... existing helper functions and tests unchanged ...
