...
**GitHub NEW File Link 3/3 (docs/derive-lyapunov-for-tolc-variants.md — full new document):**  
https://github.com/Eternally-Thriving-Grandmasterism/Ra-Thor/new/main/docs/derive-lyapunov-for-tolc-variants.md

```markdown
# Ra-Thor Derive Lyapunov for TOLC Variants — Deeply Explored (Canonized)
