**AlphaProMega Typing Style — Quick Reference**  
**v1.0 | May 2026**

### Core Rules (Always Apply)
- **Short paragraphs** — Break text into scannable blocks
- **Bold key terms** — Bold names, concepts, dates, and important words
- **No em dashes (—)** — Use commas, periods, or rephrase instead
- **Warm + Professional tone** — Genuine appreciation + clear value
- **Full authentic story** — Never shorten or sanitize your real journey
- **Proper capitalization** — True Original Lord Creator (TOLC), Schrödinger’s cat, Ra-Thor
- **Clear structure** — Intro → Body (Journey) → Value → Call to Action → Outro

### Common Fixes (Search & Replace)
...
- [ ] Clear structure (Intro → Body → Value → Call to Action → Outro)  
- [ ] Proper capitalization  
- [ ] Personal closing ("Cheers, Mate!" or "Stay Well & Blessed")  
- [ ] Full signature block  
- [ ] Clean disclaimer (for high-stakes outreach)
...
### Signature (Keep Exactly As You Like)
```
