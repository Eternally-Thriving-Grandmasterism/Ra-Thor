...
> **Namespace lock.** The “Layer 0 / 1 / 2 / 3 / 4” numbers in **this** document are a **coordination-stack index** inside and among conductors. They are **not** TOLC Layer 0. Canonical Layer 0 remains the **TOLC 8 Living Mercy Gates**. See [`LAYER0_AUTHORITY_LOCK.md`](LAYER0_AUTHORITY_LOCK.md). Councils and this coordination stack operate **under** TOLC 8. No vote here turns a gate **Rejected** into an apply.
