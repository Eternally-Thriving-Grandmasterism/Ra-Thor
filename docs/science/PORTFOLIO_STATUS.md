# Science Portfolio — Living Status
...
| **6** | Covert / dual-use / harm paths | **FORBIDDEN** | Compassion gate permanent | — |

---

## Program 1 — S-1 detail

| Tier | State |
|------|-------|
| P0 | Done |
| P1 | **Complete** (System C + harness + synthetic proof) |
| P2 | Reproduction path ready |
| P3 | **Blocked** — requires n ≥ 5 real held-out labels |
| P4 | Future |

**Claim level:** Engineering only until real labels are evaluated.  
**Critical path:** `science/s1-micro-moment/FIRST_5_CLIPS.md` + `LABELING_GUIDE.md`
...
| Item | State |
|------|-------|
| Rank | READY (not ACTIVE) |
| Artifact | `SENSITIVITY_TABLE_v0.md` + `DATA_SOURCES.md` |
