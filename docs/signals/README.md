# External signal metabolisms

**Template (use this):** [`SIGNAL_METABOLISM_TEMPLATE.md`](SIGNAL_METABOLISM_TEMPLATE.md)

| File | Topic |
| --- | --- |
| `SIGNAL_METABOLISM_TEMPLATE.md` | Standard shape for every new signal |
| `OPTICAL_SKYRMIONS_NTU_2026.md` | Optical skyrmions |
| `JWST_SATURN_BEADS_HEXAGON_2026.md` | JWST Saturn |
