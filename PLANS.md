...
### 1. Platonic Solids (v0.5.27 – Base Layer)
- Tetrahedron, Cube, Octahedron, Icosahedron, Dodecahedron
- Foundational archetypal effects (Fire, Earth, Air, Water, Ether)

### 2. Archimedean Solids (v0.5.28 – Vertex-Transitive Harmony)
- Cuboctahedron, Icosidodecahedron, Truncated Tetrahedron, Snub Cube
- Added as the first evolutionary layer beyond Platonic solids

### 3. Johnson Solids (v0.5.30 – Specialized & Intricate Forms)
- Square Gyrobicupola, Triangular Cupola, Pentagonal Rotunda, Snub Disphenoid, Bilunabirotunda
- Introduced specialized, highly differentiated effects
