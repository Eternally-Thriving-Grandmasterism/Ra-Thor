...
**Cache token:** `20260923d` (`i18n-chrome.js`, `i18n-essay.js`, and packs)  
...
FAQ keys that already had a translation still apply. This seat translates the 272 visitor essay keys in the other 22 packs. A missing key falls back to English, so the node stays filled. Filenames, emails, version tokens, and regulation acronyms stay Latin when that is the whole value.
