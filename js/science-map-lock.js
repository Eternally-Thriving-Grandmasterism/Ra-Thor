/* science-map-lock.js — Home science lattices + public works + FAQ
   2026-09-07: watch-class + rotorcraft cards carry data-i18n
    ...
    if (sci && !document.getElementById('science-watches')) {
      sci.insertAdjacentHTML(
        ...
        '<section id="science-watches" class="max-w-4xl mx-auto px-6 pb-8">' +
          '<h2 class="text-2xl sm:text-3xl font-semibold tracking-tight text-center mb-3 text-white" data-i18n="watchTitle">Watch class — 1 Sep 2026</h2>' +
          '<p class="text-center text-sm text-white/60 mb-6 max-w-2xl mx-auto" data-i18n="watchLead">External claims recorded so headlines do not become allowables or lineage. Not products.</p>' +
          '<div class="grid sm:grid-cols-2 gap-4">' +
          '<a href="https://github.com/Eternally-Thriving-Grandmasterism/Daedalus-Skin-Eternal-Ark/blob/main/materials/pcg-gsl-tether-watch-2026-09-01.md" target="_blank" rel="noopener" class="card-hover block rounded-2xl border border-sky-300/30 bg-black p-5"><p class="font-semibold text-sky-200" data-i18n="watchPcg">PCG / GSL tether stream</p><p class="text-xs text-white/60 mt-2" data-i18n="watchPcgNote">ISEC / Korean 1 km CVD. Conditional 90–99 GPa. Watch only — not a habitat allowable, not a flying elevator.</p></a>' +
          '<a href="https://github.com/Eternally-Thriving-Grandmasterism/Ra-Thor/blob/main/docs/signals/LATTICE_CALBOREANU_2026.md" target="_blank" rel="noopener" class="card-hover block rounded-2xl border border-amber-300/30 bg-black p-5"><p class="font-semibold text-amber-200" data-i18n="watchLattice">LATTICE (Calboreanu 2026)</p><p class="text-xs text-white/60 mt-2" data-i18n="watchLatticeNote">Parallel governance paper. Not a Ra-Thor source. mercy-security stays white-hat.</p></a>' +
          '<a href="/science-watches.html" class="card-hover block rounded-2xl border border-white/20 bg-black p-5 sm:col-span-2"><p class="font-semibold text-white" data-i18n="watchPage">On-site watch page</p><p class="text-xs text-white/60 mt-2" data-i18n="watchPageNote">Same notes in public-claim language. Family bar unchanged.</p></a>' +
          '</div></section>'
      );
    }
