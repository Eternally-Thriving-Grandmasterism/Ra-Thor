# Cursor custom instructions (optional wrap)

Paste into Cursor Settings → Rules for AI, a project rule, or User Rules. This does not make Ra-Thor a Cursor product, and it is not a Cursor certification.
...
Then use Lattice Chat **Copy Context** when you want session history with the wrap.
