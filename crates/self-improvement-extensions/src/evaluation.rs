...
/// 
/// Refined metrics: Removed redundant sovereignty_score field.
/// Strengthened is_acceptable() to require minimum thresholds on Non-Harm and Harmony gates
/// in addition to Sovereignty. Improves mercy alignment while preserving all core logic.
