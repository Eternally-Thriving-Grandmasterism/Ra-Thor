...
///
/// Produced by [`ArgumentGraph::calculate_influence_score`].
...
impl ArgumentGraph {
    ...
    ///
    /// Returns a non-zero score only when `enable_extension_influence` is set to `true`.
    ...
    ///
    /// When Phase 4 influence is disabled, this method behaves identically to
