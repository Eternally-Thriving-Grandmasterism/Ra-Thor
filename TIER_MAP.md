...
| `github-connector` | Offline queue + optional live PR flush |
...
Lattice Conductor mesh modules, mercy API stubs, RREL / real-estate experiments that are maintained but not required for Cosmic Tick green.
...
4. Contact remains **info@Rathor.ai** only.
