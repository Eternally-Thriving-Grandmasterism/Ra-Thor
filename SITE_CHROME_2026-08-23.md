# Site chrome contract — 2026-08-23

Launch first, then family pages.

2026-08-23 launch tick:
- ONE Organism + MercyMotionVisionEngine v2.3.1 activate on Launch-Ra-Thor.html
- Continue surface: /micro-moment.html
...
- Shared header: family-nav top pills (unless data-rt-family-header).
- Shared footer: .rt-site-footer 4-col (Trademarks / Privacy / Workspace / Family).
- xAI language lives only in Trademarks.
