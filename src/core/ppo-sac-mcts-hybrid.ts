// src/core/ppo-sac-mcts-hybrid.ts – PPO + SAC + MCTS Hybrid Engine v1.0
// Proximal Policy Optimization + Soft Actor-Critic + MCTS fusion
// Valence-shaped advantage & entropy target, mercy gating, self-play loop
...
export class PPOSACMCTSHybrid {
  private mcts: MCTS;
  private policyNet: {
    predictPolicyAndValue: (state: any) => Promise<{ policy: Map<string, number>; value: number }>;
    trainPPO: (batch: Transition[], advantages: number[], returns: number[]) => Promise<any>;
  };
