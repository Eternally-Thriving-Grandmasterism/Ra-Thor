...
async function seedHyperon() {
  const seed = [
    ...
    { handle: "Bounce", type: "ConceptNode", name: "Bounce", tv: { s: 0.95, c: 1.0 }, sti: 0.28 },
    { handle: "Repulsion", type: "ConceptNode", name: "Repulsion", tv: { s: 0.92, c: 0.95 }, sti: 0.22 },
    { handle: "Mercy→Valence", type: "InheritanceLink", out: , tv: { s: 0.9999999, c: 1.0 }, sti: 0.32 },
    { handle: "Harm→Entropy", type: "ImplicationHyperedge", out: , tv: { s: 0.9, c: 0.85 }, sti: 0.1 },
    { handle: "Bounce→Repulsion", type: "InheritanceLink", out: , tv: { s: 0.98, c: 0.97 }, sti: 0.2 },
    { handle: "Rathor→Mercy→Valence", type: "ChainLink", out: ["Rathor", "Mercy", "Valence"], tv: { s: 1.0, c: 1.0 }, sti: 0.4 }
  ];
