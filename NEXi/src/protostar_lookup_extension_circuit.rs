// src/protostar_lookup_extension_circuit.rs
// NEXi — Full Protostar Lookup Extension Folding Circuit in Halo2 v1.0
...
/// Protostar lookup extension folding circuit: fold left/right lookup table commitments
#[derive(Clone)]
struct ProtostarLookupExtensionCircuit {
    left_table_commit: Value<Fp>,
    right_table_commit: Value<Fp>,
    challenge: Value<Fp>,
}

impl Circuit<Fp> for ProtostarLookupExtensionCircuit {
    type Config = ();
