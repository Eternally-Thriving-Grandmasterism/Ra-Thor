...
assert(home.indexOf('/i18n/en.js?v=20260923a') !== -1, 'homepage pack cache buster must move');
assert(home.indexOf("s.src = '/i18n/' + lang + '.js?v=20260923a'") !== -1, 'lang tabs must load the new pack token');
